...
// print a comparison table (latency p50, tok/s, response sample).
//
// Usage:
//   pnpm --filter @chiefaia/local-llm-router run bench
//   OLLAMA_BASE_URL=http://127.0.0.1:11434 npx ts-node scripts/benchmark-catalog.ts
//
...
import { MODEL_CATALOG, type LocalModel } from '../src/model-catalog.js';
