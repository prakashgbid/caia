 ...
 *
 * Mirrors `@caia/frontend-architect/src/run.ts` aside from owned-field
 * key selection.
 */
 ...
 */
export async function runAimlArchitect(
  ...
  const validation = validateArchitectOutput(spawn.text, AIML_OWNED_FIELD_KEYS);
