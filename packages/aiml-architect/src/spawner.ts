 ...
 * This module mirrors `@caia/frontend-architect/src/spawner.ts` verbatim
 * so every V1 architect has the same spawn surface.
 */
 ...
 * `AIMLArchitect` when no spawner is injected.
 */
