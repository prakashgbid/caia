...
const SECTIONS = [
  ...
  { href: '/catalog/architecture', label: 'Architecture (AKG)', icon: '🏛️', desc: 'Architecture knowledge graph.' },
  ...
  { href: '/catalog/agents', label: 'Agents', icon: '🤖', desc: 'All 24 CAIA agents — status + drill-down.' },
