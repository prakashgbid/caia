/**
 * Dashboard API proxy: /api/oss-registry/*
 * Forwards to the orchestrator's /oss-registry/* endpoints.
 */
...
export async function GET(
  ...
  const upstreamUrl = new URL(`${ORCHESTRATOR_URL}/oss-registry/${subPath}`);
