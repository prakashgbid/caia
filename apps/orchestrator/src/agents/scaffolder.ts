...
export async function runScaffolder(
  ...
  setTimeout(() => {
    ...
    poChain
      ...
      .then(() => {
        // VAL-005: Story Validator Agent runs after BA enrichment. Per-story
        // validation; on fail, re-invokes BA up to maxAttempts; on still-fail,
        // escalates by filing a `validation-stuck` blocker. The loop advances
