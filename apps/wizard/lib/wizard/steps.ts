...
export const WIZARD_STEPS: ReadonlyArray<WizardStep> = [
  ...
  },
  {
    ...
    index: 6,
    title: 'Design & Theme',
    description: 'Pick your design system, style, and theme before anything visual is generated.',
  ...
  },
  {
    ...
    index: 7,
    title: 'Landing Page',
    description: 'CAIA drafts your app\u2019s first-look landing page using your chosen design.',
    fsmStates: ['proposal-generated'],
  },
  {
    slug: 'login',
